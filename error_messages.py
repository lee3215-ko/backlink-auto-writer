...
_RULES: list[tuple[str, str]] = [
    ...
    (r"워드프레스 댓글은 회원 로그인", "워드프레스 회원 전용 댓글 (비회원 불가)"),
    (r"포럼 답글은 회원 로그인", "포럼 회원 전용 답글 (게스트 불가)"),
    (r"포럼 답글 폼을 찾을 수 없습니다", "포럼 답글 폼 없음 (로그인·차단·목록 페이지)"),
    (r"Execution context was destroyed", "페이지 이동 중 오류 — 재시도하세요"),
    (r"Element is not an <input>", "입력란 형식 오류 (폼 구조 다름)"),
    ...
    (r"Disqus 외부 댓글", "Disqus 외부 댓글 (자동 등록 불가)"),
    (r"Facebook 댓글 플러그인", "Facebook 댓글 (자동 등록 불가)"),
